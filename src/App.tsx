...
function App() {
  const backgroundImages = {
    ...
    panels: [
      {
        image: "https://raw.githubusercontent.com/Angelio-git/GTC2/main/assets/gta6.jpg",
    ...
    <div className="relative w-full text-white">
      ...
      <section className="grid grid-cols-1 gap-4 bg-zinc-900">
        {backgroundImages.panels.map((panel, index) => (
          <div key={index} className="comic-panel rounded-xl bg-black bg-opacity-60 relative" style={{ height: '2800px' }}> {/* Increased height of the container */}
            <img 
              src={panel.image} 
              alt={`Panel ${index + 1}`} 
